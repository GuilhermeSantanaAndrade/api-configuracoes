...
routes.get("/configuracoes/:ambiente/:celula/:nivel", validateInput_consulta_get, controllerConfiguracao.consulta);
routes.get("/configuracoes/:ambiente/:celula", validateInput_consulta_get, controllerConfiguracao.consulta);
routes.post("/configuracoes/:ambiente/:celula/:nivel", validateInput_inclui_post, controllerConfiguracao.inclui);
